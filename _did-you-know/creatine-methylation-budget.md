---
layout: default
title: "Creatine supplementation frees roughly half of your body's methyl budget"
short_form: "Making creatine in your own body consumes 40 to 50 percent of the methyl groups your metabolism produces each day. Taking 3 to 5 grams of creatine as a supplement lets that budget go elsewhere: to DNA methylation, to phosphatidylcholine synthesis, to neurotransmitter production."
tags:
  - methylation
  - creatine
  - b12
  ...
  - amino-acids
date: 2026-08-14
description: "Endogenous creatine synthesis (via GAMT) is one of the two largest consumers of methyl groups in the human body, alongside hepatic phosphatidylcholine synthesis via PEMT. Supplementing creatine spares methionine, indirectly spares betaine and choline, and reduces the load on the folate/B12 remethylation cycle."
---
...
*A companion note to the forthcoming right-to-creatine fiche and to the [One Missing Letter](/critique/one-missing-letter/) argument on amino-acid triage under sufficient protein intake.*
