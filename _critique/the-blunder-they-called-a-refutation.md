...
This is the exemplar. It is taught in pharmacology, in gynaecology, in evidence-based medicine courses. It is the answer given when a student asks how EBM justifies its authority. WHI is the founding refutation, the proof that biology done without trials produces harm at population scale. That is the story.

Almost nothing about the way it is told is honest.
...
When the trial reported harm, the interpretation offered to the medical community was that replacement itself had been tested and had failed. The exemplar as it is now taught says: the biology-based hypothesis that ageing women should have their hormones restored has been refuted by evidence. This is the founding claim of the exemplar, and it is a category error. What was refuted was not the hypothesis that a woman losing ovarian function would benefit from restored estradiol and progesterone. What was refuted was the specific commercial protocol in which Wyeth's two patented products were given in blanket doses to unselected women in their sixties, most of whom were already ten to twenty years past menopause. The refutation applies to what was tested. It cannot, by any rule of experimental logic, be extended to a thesis that used different molecules, different routes, different timings, and different populations.

The trial's own protocol makes this explicit. WHI never enrolled women in early menopause on transdermal estradiol and cyclic oral progesterone. That regimen was not on the study arm. The claim that *hormone replacement* was refuted rests on the assumption that Premarin plus Provera is the same category of intervention as any other estrogen plus any other progestogen. That assumption is not a finding of the trial. It is a premise imported into its interpretation.
...
The ESTHER study, published by Scarabin and colleagues in *The Lancet* in 2003 and elaborated over the following years, examined venous thromboembolism risk by route of estrogen administration. Oral estrogens, including CEE, increased VTE risk in postmenopausal women. Transdermal estradiol, which bypasses the liver's first pass, did not. The mechanism is not controversial. Oral estrogens, whether equine or synthetic, upregulate hepatic synthesis of coagulation factors precisely because they arrive at the liver in supraphysiological concentrations that no ovarian secretion produces. Transdermal estradiol delivers to the systemic circulation the way the ovary does, and does not.
...
## The reversal EBM does not want to see

The standard argument against orthomolecular thinking, from the point of view of evidence-based medicine, is precisely that biology-based reasoning is undisciplined. That plausible mechanisms produce plausible-looking interventions that turn out, when actually tested, to harm patients. WHI is the paradigmatic example: someone reasoned that women losing estrogen should be given estrogen, someone else reasoned that a progestogen was needed to protect the endometrium, and the whole cascade of biological plausibility produced a treatment that killed people. Only trials, EBM says, can discipline this kind of thinking. The founding case of the paradigm is that biology was checked against evidence and found wrong.

This narrative has the situation inverted.

The biology-based reasoning was not that women should be given Premarin plus Provera. The biology-based reasoning is that a woman whose ovaries have ceased functioning is now producing quantities of estradiol and progesterone that her tissues, formed over sixty years of higher exposure, are not adapted to. Biology says: if you are going to intervene, restore what is missing, in the form the body recognises, at the concentration and the timing the body used to produce. This is what *replacement* would mean if the word were taken at its meaning.

What WHI tested was something else. What WHI tested was the industrial product built around the two patents that the pharmaceutical industry could sell. The molecules were chosen for supply and patent life. The dosing was chosen for regulatory simplicity. The population was chosen for logistical feasibility. Every step at which the industrial protocol departed from the physiological hypothesis was a step made by industry and regulation. The physiological reasoning EBM claims to have refuted was not the reasoning that produced the tested protocol.

The refutation was therefore of a scarecrow. The scarecrow wore lab coats and had a citation index. It looked, from outside, like the biology-based thesis. It was made of two patented molecules and two decades of marketing. The trial that took it down was, on its own terms, well conducted. The problem is not the trial. The problem is what the trial has been claimed to prove.
...
## What the exemplar proves, and what it does not

The Women's Health Initiative proves that Premarin plus Provera, given in blanket doses to unselected women a decade or more past menopause, produces net harm at the population level. This is a genuine finding. It is a useful finding for the specific commercial product it tested.

It does not prove that hormone replacement, understood as the restoration of missing endogenous hormones in the forms the body produces, is dangerous. That thesis has not been tested by WHI, because WHI did not test it. Its testing, to the extent it has occurred, is in the observational literature the same paradigm has published: E3N on bioidentical progesterone, ESTHER on transdermal estradiol, the KEEPS and ELITE trials on early-menopause initiation with different formulations. The picture that emerges from that literature is not the picture the exemplar teaches.

The exemplar teaches that biology-based reasoning about hormones is dangerous and that evidence discipline is the corrective. What actually happened is that industry-designed products were tested under a name that belongs to physiological reasoning, and the results were then generalised to a thesis those products do not represent. The confusion at the heart of the exemplar is not epistemological. It is a matter of which molecules were in the pill.
