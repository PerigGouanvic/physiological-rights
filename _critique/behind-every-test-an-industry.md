...
This is the pattern this piece describes. It is a companion to *[The Hunger We Don't See](/critique/the-hunger-we-dont-see/)*: that piece traced the technical failures of the tests that are ordered. This one traces the economic logic that determines which tests exist at all.
...
- The **calculated bioavailable D** (total 25-OH-D combined with VDBP and albumin measurements) is available commercially through specialty laboratories (Pan Laboratories, GrassrootsHealth blood spot programs, others), **not reimbursed by conventional insurance: the patient pays**.

The pattern is unmistakable: **when biology is real but the industry cares primarily about the *product* rather than the accuracy of the measurement, the test settles at the cheapest reproducible version.** Fidelity was never the point of the test. The point was to sustain a message aligned with a fortification chain and a supplement market. Better tests exist. They are sold to patients who pay for them. The medical system operates on the version that serves the industrial infrastructure.
...
The industrial infrastructure around calcium is one of the most extensively documented in nutritional epidemiology, and it has consolidated over roughly a century into a self-reinforcing arrangement legible at four levels.

At the level of dietary guidance, the United States Food Pyramid and its successor MyPlate place dairy as a separate food group. That taxonomic decision, made by no other national food guide until Canada removed its "milk and alternatives" category in 2019 under long countervailing pressure from the Dairy Farmers of Canada, encodes into state-issued nutrition education what the dairy sector requires the public to internalise: milk is not one food among others, it is a category unto itself. The Dairy Council, the Dairy Management Inc. checkoff program in the United States, and equivalent institutions in Canada, Europe, and Australasia have financed decades of public education and clinical guideline advocacy that keep this taxonomy in place.

At the level of quantified recommendation, the Dietary Reference Intakes for calcium in North America (1000 to 1200 mg per day for adults) are among the highest in the world. The World Health Organization sets its adequacy floor at 500 mg. Populations with historically low calcium intake, most of Asia in particular, do not carry elevated rates of osteoporotic fracture, and some carry lower rates than the high-consumption countries. The Institute of Medicine panels that set the North American DRIs have carried documented consultant relationships with the dairy industry, and the doubling of the WHO threshold has never been explained in strictly physiological terms.

At the level of product delivery, the fortification cascade extends beyond dairy into orange juice, breakfast cereals, plant milks, and tofu. The ubiquity of calcium fortification in non-dairy categories does more than deliver the nutrient. It validates the premise: if every product must be enriched with calcium, calcium must be essential. The Special Milk Program has distributed subsidised milk in United States schools since 1954, and school milk programs in most Canadian provinces have done comparable work north of the border. Two full generations of children have been conditioned to the equation *milk = calcium = strong bones* before reaching adulthood.

At the level of clinical downstream, a pharmaceutical cascade treats the diagnostic category the dairy infrastructure helped establish. DEXA scanning generates imaging revenue. Bisphosphonates (Fosamax, Actonel, Reclast, Boniva) constitute a multi-billion dollar market. PTH analogues (Forteo, Tymlos), denosumab (Prolia), and calcium-plus-D supplements (Caltrate, Tums in its dual-use antacid role) each occupy their own segment. Professional societies in endocrinology, rheumatology, and gynaecology in the menopause space have organised themselves around osteoporosis as a disease entity and around calcium as a therapeutic lever, providing the professional constituency that makes the whole apparatus legible as medicine.
...
**The moral capital of childhood blindness in the Global South is used to justify a fortification infrastructure in populations where clinical deficiency is rare.** The rhetorical move is never made explicitly, but it is the ambient logic: *since children are going blind in Bangladesh, your milk in Montréal is fortified with vitamin A*.
...
- **Omega-3 (RBC Omega-3 Index; see [Omega-3](/rights/omega-3/)).** Fish oil is a real industry but small and fragmented. Countervailing pressure comes from the **industrial seed-oil industry** (soybean, corn, sunflower, canola), which has a direct interest in the omega-6-to-omega-3 ratio remaining an invisible variable.
- **Zinc, selenium, iodine (in Occident), boron, choline.** No dedicated food industries of comparable clout; not on the routine panel.
- **[Riboflavin (B2)](/rights/riboflavin-b2/), [thiamine (B1)](/rights/thiamine-b1/), the [vitamin E family](/rights/vitamin-e/)** beyond alpha-tocopherol. Fortified in various forms but not tested with functional markers (EGRAC, ETKAC, gamma- and delta-tocopherol) in general practice.

These are the nutrients whose depletion is documented in the founding clinical cases of the physiological rights framework. They are not obscure. They are systemic. They are unmeasured because there is no economic constituency organised to demand that they be measured.
...
1. **The right to physiological measurement cannot be delegated to the constellation of tests that food industries have found profitable to promote.** The map is not the territory. The unmeasured nutrient is not the unimportant nutrient.
2. **Iron is the demonstration that a proper multi-marker nutrient panel is technically feasible** (has been technically feasible for over a century) when the political-economic conditions align. The obstacle to a functioning Mg panel, K panel, K2 panel, functional B12 panel, Omega-3 Index panel, is nowhere technical. It is that no constituency of iron's weight has organised itself around them.
3. **Fortification is not the answer, and the fortification framework is not neutral.** Folic acid fortification masked B12 deficiency for two decades and is defended not because the harm is disproven but because reopening the debate threatens an industry. Universal vitamin A fortification circulates a product without ever measuring its effect on the individual body: a structural evasion of physiological verifiability.
4. **The DRI/RDA numbers are not settled science.** They are the outputs of committees whose composition is subject to industrial capture. When the North American calcium DRI is roughly double the WHO's, when refined flour is fortified with iron but not magnesium in populations where magnesium depletion is at least as prevalent as iron depletion, when reference ranges for serum Mg have been challenged by the MaGNet international network for a decade without institutional response, these are political facts, not technical ones.
5. **The named right.** Every person has the right to have their essential physiological parameters *tested*, not just the ones the food industry has found profitable to promote. Denial of this (through structural absence of the test, through unreimbursement, through a specialty gate) is a violation of a physiological right. It is not less serious because the missing test is unfamiliar.
...
The right to physiological integrity is the right to a map drawn against the actual shape of the body's needs. The panel your doctor orders is a map of industrial alignments: of dairy, of grain, of pharma, of what has proven reimbursable. It is not a map of the body. The industries that drew it will not redraw it. That is what this project is for.
