...
The full physiology of iron sufficiency, and the reasons the standard panel misses it, are elaborated in the [iron](/rights/iron/) fiche.
...
The full doctrinal architecture is developed in [The Instruments Already Exist](/definitions/the-instruments-already-exist/). The frame within which Jane's claim is not a claim in evidence-based medicine but in rights-based medicine is developed in [Rights-Based Medicine vs Evidence-Based Medicine](/definitions/rights-based-vs-evidence-based/). The reason the systemic reading of the right to health does not reach Jane is developed in [Inadequacy of the Right to Health](/definitions/inadequacy-of-right-to-health/). The general architecture of the framework Jane is invoking is in [Physiological Rights](/definitions/physiological-rights/).
