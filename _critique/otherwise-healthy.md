...
Membrane transport is drawn as a channel with an arrow through it, without any drawn requirement for adequate ATP, magnesium at the ATPase, cholesterol at the correct membrane fraction, EPA and DHA at the phospholipid composition (see [Omega-3](/rights/omega-3/)), or intact glycocalyx.
...
What is not measured at screening, and therefore not documented, and therefore not disqualifying, includes: serum 25-hydroxyvitamin D, [erythrocyte magnesium](/rights/magnesium/), the [Omega-3 Index](/rights/omega-3/), free triiodothyronine and reverse T3, [homocysteine, methylmalonic acid, and holotranscobalamin](/rights/folate/), lipid-corrected ferritin, gamma-tocopherol (see [Vitamin E](/rights/vitamin-e/)), fasting insulin and HOMA-IR, the salivary cortisol curve, thyroid antibodies, vitamin K2 status, choline and betaine, [potassium](/rights/potassium/) at the cellular level.
...
The diagnostic side of the same erasure, in which the tests that would have named the deficits are almost never ordered, is developed at length in [The Hunger We Don't See](/critique/the-hunger-we-dont-see/). The doctrinal reply that returns the burden of proof to the discipline is developed in [Rights-Based Medicine vs Evidence-Based Medicine](/definitions/rights-based-vs-evidence-based/).
