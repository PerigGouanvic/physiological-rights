...
On 5 April 2005, the Advocate General of the Court of Justice of the European Communities delivered his opinion in the joined cases[^anh-cases] challenging Directive 2002/46/EC on food supplements.[^supplements-directive] In our timeline the opinion is thoughtful, sides partly with the industry challengers, and is largely followed by the Court in its judgment of 12 July 2005: the directive is upheld, subject to procedural safeguards for the inclusion of new substances on the positive list. The practical effect is that hundreds of substances that were legally sold in the European Union before the directive are quietly delisted over the following decade. The burden of proof for inclusion falls on manufacturers of substances that no one owns the exclusive right to sell, which is to say, on no one at all.
...
In 2017 the Seventeen Years Task Force spins off a companion body dedicated to what it calls, in its foundational document, "endogenous molecules of chronic clinical relevance for which no commercial actor has a translational incentive." The colloquial name that attaches to the new body is the Seventy Years Task Force, drawn from the median counterfactual lag its retrospective survey documents across findings of this class. Flink's description is the emblematic case. The list, first published in 2018, is shorter than that of the parent body and its findings are older. The oldest items reach back to the 1930s.
