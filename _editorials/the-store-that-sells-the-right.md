...
*Companion, on the other side of the counter, to [Behind Every Test, an Industry](/critique/behind-every-test-an-industry/). That piece described how the medical mainstream chooses the nutrients it measures. This one describes what the alternative economy does with the nutrients the mainstream declines to measure.*
...
- **Third-party verifiers** (ConsumerLab, USP Verified, NSF): they do not sell, they certify. They play a real role but are marginal in visibility.
- **Clinician brands** (Thorne, Pure Encapsulations, Designs for Health): quality-focused, formulation-coherent, but expensive and gatekept behind practitioners.
- **Public fortifications** (folate in flour, iodine in salt): the structural exception. When the state acts, the rent extraction disappears. The physiological right is delivered at cost.
- **Clinician-authors** (Alan Gaby, Jonathan Wright, Michael Murray): a literature written outside the sales relationship, honest and useful.
- **The Life Extension Foundation** publishes and funds some research, but it also sells. The ambivalence is internal.
