...
3. **A composite clinical assessment** — symptoms, dietary intake, ongoing losses (heat, physical load, medications, stimulants, GI history), co-nutrient status (magnesium in particular) — rather than reliance on a single lab value.
