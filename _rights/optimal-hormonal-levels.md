...
> *"The reason so many people go through life feeling tired, dull, and unwell is that they are, in fact, hypothyroid but their doctors do not know it."*
...
The critique piece [*Behind Every Test, an Industry*](/critique/behind-every-test-an-industry/) documents the same structural pattern in the biochemistry of vitamins and minerals. This page extends it to the hormonal register. The framework under which the right is articulated is developed in [The Physiological Rights](/definitions/physiological-rights/) and in [*All Medicine Is Preventive*](/definitions/all-medicine-is-preventive/).
...
- **What medicine does well.** The categorical cases, where the diagnosis is unambiguous and the treatment is delivered with something approaching adequacy. The floor of the discipline. Nothing polemical here.
- **What medicine does badly.** The tests it uses, which are the wrong tests or the incomplete tests for the question actually being asked. The reference ranges it uses, which are calibrated to the population and not to the physiology of the person. The historical reversals that closed doors for a generation.
- **What medicine does not do at all.** The tests that exist, are validated, and are not ordered. The treatments that exist, are safe, and are not offered. The naming that is absent because the discipline has not accepted the entity into its nosology.
...
The doctrinal ground for all of this is the analogy explicit in [*All Medicine Is Preventive*](/definitions/all-medicine-is-preventive/): the postmenopausal woman receiving bioidentical estradiol and micronised progesterone is meeting a physiological requirement whose endogenous source has ceased. The distinction between this and the Type 1 diabetic taking exogenous insulin is one of degree, not of kind.
...
The pattern repeats what this resource has documented at the level of nutrients. [Ferritin](/critique/otherwise-healthy/) at 15 μg/L, calibrated to avoid the categorical anaemia and mistaken for a threshold of tissue adequacy. [Serum potassium](/critique/false-negative-serum-potassium/) within range while intracellular depletion progresses. Serum magnesium within range while red-cell magnesium is low, documented in [Magnesium](/rights/magnesium/). The same epistemic move is at work. The population reference and the functional target have been conflated, and the conflation is the wall between the person and the correction.
...
The pattern rhymes with the parallel documented for nutrients in [*The Hunger We Don't See*](/critique/the-hunger-we-dont-see/) and for iron in [*Otherwise Healthy*](/critique/otherwise-healthy/): the endpoint is diagnosed, and the causally relevant substrate whose measurement would have permitted upstream correction is not on the panel.
...
The landscape assembled here is provisional. Each of the five axes deserves the full treatment that this resource gives to a single nutrient in [Magnesium](/rights/magnesium/) or to a single physiological parameter in [Muscle Mass](/rights/muscle-mass/): a founding history of the deficit's recognition, a named lineage of researchers, a critique of the test infrastructure, a mechanistic exposition, a table of associated conditions, a timeline, a bibliography. Those pages are in preparation. This page is the map on which they will hang.
...
3. Bianco AC, Dumitrescu A, Gereben B, et al. *Paradigms of dynamic control of thyroid hormone signaling.* Endocrine Reviews. 2019;40(4):1000-1047. [PubMed 31033998](https://pubmed.ncbi.nlm.nih.gov/31033998/)
4. Wilson RA. *Feminine Forever.* M. Evans and Company, 1966.
5. Rossouw JE, Anderson GL, Prentice RL, et al. *Risks and benefits of estrogen plus progestin in healthy postmenopausal women: principal results from the Women's Health Initiative randomized controlled trial.* JAMA. 2002;288(3):321-333. [PubMed 12117397](https://pubmed.ncbi.nlm.nih.gov/12117397/)
6. Manson JE, Chlebowski RT, Stefanick ML, et al. *Menopausal hormone therapy and health outcomes during the intervention and extended poststopping phases of the Women's Health Initiative randomized trials.* JAMA. 2013;310(13):1353-1368. [PubMed 24084921](https://pubmed.ncbi.nlm.nih.gov/24084921/)
7. Prior JC. *Progesterone as a bone-trophic hormone.* Endocrine Reviews. 1990;11(2):386-398. [PubMed 2194788](https://pubmed.ncbi.nlm.nih.gov/2194788/)
8. Prior JC. *Estrogen's Storm Season: Stories of Perimenopause.* Centre for Menstrual Cycle and Ovulation Research, 2005.
9. The 2022 Hormone Therapy Position Statement of The North American Menopause Society Advisory Panel. *The 2022 hormone therapy position statement of The North American Menopause Society.* Menopause. 2022;29(7):767-794. [PubMed 35797481](https://pubmed.ncbi.nlm.nih.gov/35797481/)
10. Davis SR, Baber R, Panay N, et al. *Global Consensus Position Statement on the Use of Testosterone Therapy for Women.* Journal of Clinical Endocrinology and Metabolism. 2019;104(10):4660-4666. [PubMed 31498871](https://pubmed.ncbi.nlm.nih.gov/31498871/)
11. Heller CG, Myers GB. *The male climacteric: its symptomatology, diagnosis and treatment.* JAMA. 1944;126(8):472-477.
12. Vermeulen A, Verdonck L, Kaufman JM. *A critical evaluation of simple methods for the estimation of free testosterone in serum.* Journal of Clinical Endocrinology and Metabolism. 1999;84(10):3666-3672. [PubMed 10523012](https://pubmed.ncbi.nlm.nih.gov/10523012/)
13. Harman SM, Metter EJ, Tobin JD, Pearson J, Blackman MR. *Longitudinal effects of aging on serum total and free testosterone levels in healthy men.* Journal of Clinical Endocrinology and Metabolism. 2001;86(2):724-731. [PubMed 11158037](https://pubmed.ncbi.nlm.nih.gov/11158037/)
14. Bhasin S, Brito JP, Cunningham GR, et al. *Testosterone therapy in men with hypogonadism: an Endocrine Society clinical practice guideline.* Journal of Clinical Endocrinology and Metabolism. 2018;103(5):1715-1744. [PubMed 29562364](https://pubmed.ncbi.nlm.nih.gov/29562364/)
15. Selye H. *A syndrome produced by diverse nocuous agents.* Nature. 1936;138:32.
16. Selye H. *The Stress of Life.* McGraw-Hill, 1956.
17. Nieman LK, Biller BMK, Findling JW, et al. *The diagnosis of Cushing's syndrome: an Endocrine Society clinical practice guideline.* Journal of Clinical Endocrinology and Metabolism. 2008;93(5):1526-1540. [PubMed 18334580](https://pubmed.ncbi.nlm.nih.gov/18334580/)
18. Cadegiani FA, Kater CE. *Adrenal fatigue does not exist: a systematic review.* BMC Endocrine Disorders. 2016;16(1):48. [PubMed 27557747](https://pubmed.ncbi.nlm.nih.gov/27557747/)
19. Kraft JR. *Diabetes Epidemic and You.* Trafford Publishing, 2008.
