...
> — DiNicolantonio et al., *Open Heart* (BMJ), 2018
...
|---|---|
| Cardiovascular | Hypertension, arrhythmias, sudden death, atherosclerosis, heart failure |
| Metabolic | Type 1 and 2 diabetes, metabolic syndrome, insulin resistance |
| Skeletal | Osteoporosis, fractures, vitamin D-resistant rickets |
| Neurological/mental | Depression, anxiety, migraines, insomnia, ADHD, Alzheimer's, Parkinson's |
| Reproductive | Pre-eclampsia, eclampsia, prematurity, low birth weight |
| Respiratory | Asthma, COPD |
| Renal | Kidney stones (calcium oxalate) |
| Ocular | Cataracts, glaucoma |
| Dermatological | Atopic dermatitis |
| Oncological | Increased risk of colorectal and breast cancer |
...
| 1990 | Kubena & Durlach document chronic latent deficit | No protocol change |
| 2003 | Seelig & Rosanoff: *The Magnesium Factor* | The general public barely begins to hear |
| 2010 | Formal warning: serum test is misleading | Laboratories do not change their thresholds |
| 2017 | Schwalfenberg & Genuis: Level I evidence | Medical education remains unchanged |
| 2018 | DiNicolantonio: "public health crisis" | No national screening policy |
| 2022 | MaGNet recommends threshold at 0.85 mmol/L | Not adopted by laboratories |
| 2025 | 2.4 billion people deficient | Official advice remains "eat a balanced diet" |

---

## References

1. Magnesium research: a brief historical account — [PubMed](https://pubmed.ncbi.nlm.nih.gov/3079206/)
2. Challenges in the Diagnosis of Magnesium Status — [PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC6163803/)
3. Magnesium research: from the beginnings to today — [PubMed](https://pubmed.ncbi.nlm.nih.gov/15724863/)
4. Obituary Jean Durlach — [SDRM Society](https://www.sdrmsociety.org/wp-content/uploads/2020/05/Obituary.pdf)
5. Preface — *Magnesium Deficiency in the Pathogenesis of Disease*, Dr. Mildred S. Seelig — [mgwater.com](http://www.mgwater.com/Seelig/Magnesium-Deficiency-in-the-Pathogenesis-of-Disease/preface.shtml)
6. Global Dietary Magnesium Deficiency: Prevalence, Underlying Causes... — [IJVNR 2025](https://www.imrpress.com/journal/IJVNR/95/6/10.31083/IJVNR46828)
7. DiNicolantonio et al. — Subclinical magnesium deficiency: a principal driver of cardiovascular disease and a public health crisis — [Open Heart / BMJ 2018](https://openheart.bmj.com/content/5/1/e000668)
8. Magnesium basics — [PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC4455825/)
9. Magnesium Metabolism — [ScienceDirect](https://www.sciencedirect.com/topics/immunology-and-microbiology/magnesium-metabolism)
10. Schwalfenberg & Genuis — The Importance of Magnesium in Clinical Healthcare — [PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC5637834/)
11. Magnesium activates enzymes — [magnesium.ca](https://magnesium.ca/us/magnesium-activates-enzymes/)
12. The Integral Role of Magnesium in Muscle Integrity and Aging — [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10745813/)
13. The pivotal role of magnesium in energy production — ATP synthesis — [Formexc](https://formexc.com/blogs/insights/the-role-of-magnesium-bisglycinate-in-energy-production-atp-synthesis)
14. How Magnesium Boosts Energy: The Key to Cellular ATP Production — [Behrhaus](https://behrhaus.com/blogs/behr-living-articles/how-magnesium-boosts-energy-the-key-to-cellular-atp-production)
15. Magnesium Deficiencies — [CMER](https://magnesiumeducation.com/magnesium-deficiency/)
16. A Comprehensive Review on Understanding Magnesium Disorders — [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC11444808/)
17. Depleted Soil and the Global Magnesium Deficiency Problem — [Magtein](https://magtein.com/2025/11/19/soil-magnesium-depletion/)
18. Going to the roots of reduced magnesium dietary intake — [PMC/NIH](https://pmc.ncbi.nlm.nih.gov/articles/PMC7649274/)
19. Why Is Soil Depletion a Growing Concern for Magnesium Content in Food? — [Sustainability Directory](https://lifestyle.sustainability-directory.com/learn/why-is-soil-depletion-a-growing-concern-for-magnesium-content-in-food/)
20. The Health And Economic Burden of Desalination — [Taub Center](https://www.taubcenter.org.il/en/research/magnesium-deficiency/)
21. How Many Americans Are Magnesium Deficient? — [Life Extension](https://www.lifeextension.com/magazine/2005/9/americans-magnesium-deficient)
22. The Magnesium Miracle: An Interview with Dr. Carolyn Dean — [My Conscious Life Journal](https://myconsciouslifejournal.com/articles/magnesium-miracle-dr-carolyn-dean/)
23. Seelig & Rosanoff — *The Magnesium Factor* — [Bookshop.org](https://bookshop.org/p/books/the-magnesium-factor-mildred-seelig/577315)
24. Novel Scale for Clinical Identification of Adverse Magnesium-Calcium Imbalances — [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC12694097/)
25. Interview With Leading Magnesium Researcher — Dr. Andrea Rosanoff PhD — [YouTube](https://www.youtube.com/watch?v=J-6OC5x05C8)
26. Nutrients, Vol. 17, Pages 3662 — [Biblioteca Digital UCEM](https://bibliotecadigital.ucem.edu.mx/nutrients-vol-17-pages-3662-novel-scale-for-clinical-identification-of-adverse-magnesium-calcium-imbalances-applications-and-perspectives/)
27. MaGNet — Recommendation on an updated standardization of serum magnesium — [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC9186275/)
28. Kubena & Durlach — Historical review of the effects of marginal intake — [PubMed](https://pubmed.ncbi.nlm.nih.gov/2132753/)
29. The Underestimated Problem of Using Serum Magnesium Measurements — [PubMed](https://pubmed.ncbi.nlm.nih.gov/20170394/)
