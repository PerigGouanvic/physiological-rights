...
> *"The demonstration of the ubiquitous distribution of coenzyme Q10 in tissues, and its central role in the mitochondrial respiratory chain, should have made its adequate supply a matter of routine clinical concern decades ago."*
> — Karl Folkers, *Proceedings of the National Academy of Sciences*, 1985
...
- When electron transfer through the reduced Q10 pool slows, electrons leak. The leaked electrons produce superoxide. The mitochondrion responds by upregulating the antioxidant system that neutralizes superoxide: manganese superoxide dismutase, glutathione peroxidase, thioredoxin. The [glutathione pool](/rights/glutathione/) is drawn down to handle the leak. The compensation works, and the visible endpoint (cell death, apoptosis) does not occur. The invisible endpoint (chronic drawdown of the reducing capacity of the cell) accumulates.
- When ATP output per unit of substrate falls, the cell shifts fuel selection. Glycolysis increases relative to oxidative phosphorylation. The Warburg-like shift is subtle in a healthy tissue and only unmasked at high demand, but it changes the metabolic signature of the tissue over years.
- Uncoupling proteins UCP2 and UCP3 are induced. They dissipate part of the proton gradient as heat rather than as ATP. This reduces the electron leak but also reduces the efficiency of oxidative phosphorylation. The cell burns more substrate for less ATP.
- PGC-1α is activated. Mitochondrial biogenesis increases. The cell responds to per-mitochondrion insufficiency by making more mitochondria. Total mitochondrial mass rises. A muscle biopsy that measures total Q10 in a homogenate sees the pool preserved, because the compensation succeeded. The per-mitochondrion pool is lower, the demand per unit of ATP produced is higher, and the tissue is running on a wider but shallower machinery.
- Damaged mitochondria are cleared by mitophagy. Cristae are remodeled by OPA1. The architecture of the organelle is rebuilt around the shortage.
...
This is the argument developed in [All Medicine Is Preventive](/definitions/all-medicine-is-preventive/): the essentiality of a nutrient is a relationship between the organism, its state, and the metabolic load imposed on it. Under a statin, coenzyme Q10 becomes essential in a way it was not before. The pharmacological choice creates the essentiality. The right to the substrate follows from the choice.
...
The reference range in most laboratories is derived from a general population that includes statin users, that includes older adults with age-related decline, and that includes no reference to the mitochondrial pool. A plasma Q10 in the low-normal range in a person on a statin is not evidence of adequacy. It is evidence that the buffered deficit is doing what buffered deficits do: keeping the compartment sampled at the concentration that will not alarm the assay. This is the general problem described in [Calibrated for Nothing](/critique/calibrated-for-nothing/): the reference range is calibrated to the population, not to the tissue.

More informative measurements exist and are almost never used:

- The **ubiquinol-to-ubiquinone ratio** in plasma, which reports on the systemic redox environment.
- **Platelet or muscle Q10**, which correlates better than plasma with mitochondrial content but requires invasive sampling.
- **Functional indices** of mitochondrial reserve: VO2 max, cardiac output at maximal effort, muscle phosphocreatine recovery after exercise (by 31P-MRS). These integrate over all components of the respiratory chain, but a chronic drop is not compatible with an adequate Q10 pool.
...
- Automatic co-prescription of coenzyme Q10 100-200 mg/day with any statin initiation, treated as part of the drug's indication rather than as an optional add-on.
- Plasma Q10 available on request, and offered to any patient reporting muscle, energy, or cognitive symptoms on a statin, before the symptoms are re-attributed to psychology.
- Reference thresholds that reflect the mitochondrial pool the population needs, not the population's current distribution while half of it is being depleted by prescription.

**In cardiology:**
- Coenzyme Q10 recognized as an adjunct in heart failure at Q-SYMBIO-level indications, not as an alternative or curiosity.
- Coenzyme Q10 available to patients with cardiomyopathy of any origin.

**In neurology and other:**
- Coenzyme Q10 available for migraine prophylaxis, mitochondrial disorders, and any condition with a documented mitochondrial component.

**In diagnosis:**
- Plasma coenzyme Q10 and the ubiquinol/ubiquinone ratio available on request, without gatekeeping around a prior authorization that requires proof of the deficit the test would establish.
